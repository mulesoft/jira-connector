    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public UpdateIssuesByJqlMessageProcessor(String operationName) {
        super(operationName);
    }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(new DefaultListMetaDataModel(getPojoOrSimpleModel(RemoteIssue.class))));
    }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at JiraConnector at updateIssuesByJql retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
