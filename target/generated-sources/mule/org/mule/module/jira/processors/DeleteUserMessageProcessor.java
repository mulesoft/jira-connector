...
/**
 * DeleteUserMessageProcessor invokes the {@link org.mule.module.jira.JiraConnector#deleteUser(java.lang.String)} method in {@link JiraConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedUsername = ((String) evaluateAndTransform(getMuleContext(), event, DeleteUserMessageProcessor.class.getDeclaredField("_usernameType").getGenericType(), null, username));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((JiraConnector) object).deleteUser(_transformedUsername);
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at JiraConnector at deleteUser retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
