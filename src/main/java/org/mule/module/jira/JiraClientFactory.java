...
public class JiraClientFactory {
    ...
    public static JiraClient getClient(String username, String password, String address) {
        if (defaultClient != null) {
            return defaultClient;
        }
        return new AxisJiraClient(new DefaultAxisPortProvider(username, password, address));
    }
